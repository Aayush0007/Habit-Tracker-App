export const EXAM_DATES = [
  ...
  { name: 'IBPS SO Pre', date: '2026-08-23', color: 'text-indigo-400' },
  ...
  { name: 'IBPS Clerk Main', date: '2026-11-14', color: 'text-cyan-700' },
  { name: 'RRB PO Pre', date: '2026-11-21', color: 'text-rose-400' },
  { name: 'RRB Clerk Pre', date: '2026-12-06', color: 'text-rose-500' },
  { name: 'RRB PO Mains', date: '2026-12-27', color: 'text-rose-600' },
